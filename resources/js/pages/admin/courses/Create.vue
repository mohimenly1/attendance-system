  ...
  <AuthenticatedLayout>
    ...
    <div class="max-w-2xl mx-auto mt-10 p-10 bg-[#1e293b] rounded-3xl shadow-2xl border border-indigo-100 form-card-prominent">
      ...
      <div class="flex items-center mb-8 border-b pb-4 border-indigo-200">
        ...
        <h2 class="text-3xl font-extrabold text-white leading-tight">Add New Course</h2>
      </div>
      ...
      <form @submit.prevent="submit" class="space-y-6">
        ...
        <!-- Course Name -->
        <div>
          <label for="name" class="block mb-2 font-bold text-gray-300">Course Name</label>
          <input
            id="name"
            v-model="form.name"
            type="text"
        ...
        <!-- Course Code -->
        <div>
          <label for="code" class="block mb-2 font-bold text-gray-300">Course Code</label>
          <input
            id="code"
            v-model="form.code"
            type="text"
        ...
        <!-- Teacher -->
        <div>
          <label for="teacher_id" class="block mb-2 font-bold text-gray-300">Teacher</label>
          <select
            id="teacher_id"
